...
LOAD DATA LOCAL INFILE 'C:\\Users\\Usuario\\DAM\Bases de datos\\Unidad2-SQL\\Ejercicios\\Ejercicio2\\Ejercicio2_txts\\Marcas.txt'
    INTO TABLE marcas
    LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
LOAD DATA LOCAL INFILE 'C:\\Users\\Usuario\\DAM\Bases de datos\\Unidad2-SQL\\Ejercicios\\Ejercicio2\\Ejercicio2_txts\\Automoviles.txt'
    INTO TABLE automoviles
    FIELDS TERMINATED BY '\t'
    LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
LOAD DATA LOCAL INFILE 'C:\\Users\\Usuario\\DAM\Bases de datos\\Unidad2-SQL\\Ejercicios\\Ejercicio2\\Ejercicio2_txts\\Clientes.txt'
    INTO TABLE clientes
    FIELDS TERMINATED BY '\t'
    LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
LOAD DATA LOCAL INFILE 'C:\\Users\\Usuario\\DAM\Bases de datos\\Unidad2-SQL\\Ejercicios\\Ejercicio2\\Ejercicio2_txts\\Contratos.txt'
    INTO TABLE contratos
    FIELDS TERMINATED BY '\t'
    LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
LOAD DATA LOCAL INFILE 'C:\\Users\\Usuario\\DAM\Bases de datos\\Unidad2-SQL\\Ejercicios\\Ejercicio2\\Ejercicio2_txts\\Contratos2.txt'
...
LOAD DATA LOCAL INFILE 'C:\\Users\\Usuario\\DAM\Bases de datos\\Unidad2-SQL\\Ejercicios\\Ejercicio2\\Ejercicio2_txts\\Contratos3.txt'
