...
public class App {
    ...
    private static void leerFichajes(ArrayList<Empleados> lista) throws FileNotFoundException, IOException {
        BufferedReader br = new BufferedReader(new FileReader("Programación\\Java\\src\\examenes\\examen5\\solucion\\fichajes.csv"));
        String[] linea = null;
        while (br.ready()) {
    ...
    private static void escribirFichero(ArrayList<Empleados> lista) throws IOException {
        BufferedWriter bw = new BufferedWriter(new FileWriter("Programación\\Java\\src\\examenes\\examen5\\solucion\\nominas.csv"));
