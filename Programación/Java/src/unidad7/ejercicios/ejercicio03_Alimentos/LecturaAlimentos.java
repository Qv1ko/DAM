package unidad7.ejercicios.ejercicio03_Alimentos;
...
public class LecturaAlimentos {
    ...
    public static void main(String[] args) {
        File fichero = new File("Programación\\Java\\src\\unidad7\\ejercicios\\ejercicio03_Alimentos\\alimentos.csv");
        ...
        try {
            ...
            bw = new BufferedWriter(new FileWriter("Programación\\Java\\src\\unidad7\\ejercicios\\ejercicio03_Alimentos\\misCompras.txt"));
            while (br.ready()) {
