package unidad7.ejercicios.ejercicio3_Hangar;
...
public class Hangar {
    ...
    private static void importData(Map<String, Naves> navesHangar) {
        ...
        try {
            br = new BufferedReader(new FileReader("Programación\\Java\\src\\unidad7\\ejercicios\\ejercicio3_Hangar\\data.csv"));
            while (br.ready()) {
    ...
    private static void exportData(Map<String, Naves> navesHangar) {
        ...
        try {
            bw = new BufferedWriter(new FileWriter("Programación\\Java\\src\\unidad7\\ejercicios\\ejercicio3_Hangar\\data.csv"));
            for (String naveKey : navesHangar.keySet()) {
