...
SELECT * FROM clientes 
    INTO OUTFILE "C:\\Users\\Usuario\\DAM\bases_de_datos\\unidad2-sql\\ejercicios\\data\\alquileres_clientes.txt";
...
SELECT nombre AS Nombre,apellidos AS Apellidos,ABS(DATEDIFF(ffinal,finicial)*precio) AS "Importe relativo"
    ...
    WHERE ffinal IS NOT NULL 
        INTO OUTFILE "C:\\Users\\Usuario\\DAM\bases_de_datos\\unidad2-sql\\ejercicios\\data\\alquileres_contratos_finalizados.txt";
